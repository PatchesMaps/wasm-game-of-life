...
export class Universe {
    ...
    */
    toggle_cell(row, column, live_only) {
        wasm.universe_toggle_cell(this.ptr, row, column, live_only);
    }
    /**
    * @param {number} row
    * @param {number} col
    */
    spawn_spaceship(row, col) {
        wasm.universe_spawn_spaceship(this.ptr, row, col);
    }
    /**
    * @returns {number}
    */
    ...
    */
    tick(forward) {
        wasm.universe_tick(this.ptr, forward);
    }
    /**
