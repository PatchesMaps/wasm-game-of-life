...
export function universe_toggle_cell(a: number, b: number, c: number, d: number): void;
export function universe_spawn_spaceship(a: number, b: number, c: number): void;
export function universe_cells(a: number): number;
export function universe_tick(a: number, b: number): void;
